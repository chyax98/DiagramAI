 ...
 * L3: D2 系统架构图生成提示词
 *
 * 作用：定义 D2 系统架构图的生成规则、示例和最佳实践
 * Token 预算：800-1200 tokens
 * 图表类型：D2 Architecture Diagram（系统架构图）
 *
 * 用途：表示软件系统的整体架构、组件关系、技术栈分层等
 *
 * @example
 * 用户输入："绘制一个三层 Web 应用架构，包含前端、后端和数据库"
 * 输出：完整的 D2 Architecture 代码
 */

export const D2_ARCHITECTURE_PROMPT = `
# D2 系统架构图生成要求
