/**
 * L3: Vega-Lite Scatter Plot 生成提示词
 *
 * 作用：定义散点图的生成规则、示例和最佳实践
 * Token 预算：800-1200 tokens
 * 图表类型：Vega-Lite Scatter Plot（散点图）
 *
 * 用途：
 * - 相关性分析（如身高与体重、价格与销量）
 * - 分布展示（如考试成绩分布、用户活跃度分布）
 * - 异常值检测（如离群点识别）
 * - 分类散点图（如不同类别的数据点）
 *
 * @example
 * 用户输入："展示身高和体重的关系，数据：(170,65), (175,70), (165,60), (180,75), (168,62)"
...
/**
 * Token 估算: 约 1140 tokens
 *
 * 分配明细:
 * - 专家视角: 110 tokens
 * - 核心语法: 240 tokens
 * - 生成示例: 530 tokens（3个示例，每个约 175-180 tokens）
