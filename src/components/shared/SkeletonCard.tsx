...
export function SkeletonCard() {
  return (
    <div className="animate-pulse rounded-lg border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 p-4 shadow-sm">
      ...
      <div className="mb-3 space-y-2 rounded bg-slate-50 dark:bg-slate-700/50 p-3">
        <div className="h-2 w-full rounded bg-slate-200 dark:bg-slate-600" />
        <div className="h-2 w-4/5 rounded bg-slate-200 dark:bg-slate-600" />
