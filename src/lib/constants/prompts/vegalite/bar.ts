/**
 * L3: Vega-Lite Bar Chart 生成提示词
 *
 * 作用：定义柱状图的生成规则、示例和最佳实践
 * Token 预算：800-1200 tokens
 * 图表类型：Vega-Lite Bar Chart（柱状图）
 *
 * 用途：
 * - 分类数据对比（如销量、人数、评分）
 * - 排名展示（Top N）
 ...
 *
 * @example
 * 用户输入："展示 A、B、C、D、E 五个类别的销售数量，分别是 28、55、43、91、81"
 * 输出：完整的 Vega-Lite Bar Chart JSON 代码
 */

export const VEGALITE_BAR_PROMPT = `
